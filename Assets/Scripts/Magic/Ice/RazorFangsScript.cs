...
[CreateAssetMenu(fileName = "New Magic Move", menuName = "Magic Move/Razor Fangs")]
public class RazorFangsScript : MagicMoveSO
{
    private static readonly int razorHash = Animator.StringToHash("RazorFangs");
    ...
    public override void Activate() {
        ...
        playerCombat.animator.SetTrigger(razorHash);
